...
const App = () => {
  return (
    <div style={{padding:40}}>
      ...
      <p>
        Esta Política de Privacidade pode ser atualizada de tempos em tempos. Recomendamos que você revise esta página periodicamente para obter as informações mais recentes sobre nossas práticas de privacidade.
      </p>
      <h2>Contate-Nos</h2>
      <p>
